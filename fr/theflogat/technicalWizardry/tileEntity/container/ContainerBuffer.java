...
public class ContainerBuffer extends Container{
	...
	private TEBuffer buff;

	public ContainerBuffer(InventoryPlayer invPlayer, TEBuffer entity) {
		this.buff = entity;
	...
	public boolean canInteractWith(EntityPlayer player) {
		return buff.isUseableByPlayer(player);
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int i) {
	  ...
	  if(slot != null && slot.getHasStack()) {
	        ...
	        } else if(!mergeItemStack(itemstack, 36, 36 + buff.getSizeInventory(), false)) {
	          return null;
	        }
