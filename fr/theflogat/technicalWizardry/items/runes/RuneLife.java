...
public class RuneLife extends Item{
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    	if(Keyboard.isKeyDown(42)){
    		par3List.add("Right-click on Sapplings, Wood and Grass");
    		par3List.add("No OreDict yet");
    	} else {
	...
	public void registerIcons(IconRegister icon) {
		itemIcon = icon.registerIcon(References.MOD_ID.toLowerCase() + ":" + Names.RuneLife_UnlocalizedName);
	}
