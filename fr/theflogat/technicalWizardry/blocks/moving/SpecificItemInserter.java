...
public class SpecificItemInserter extends BlockContainer{
	...
	public SpecificItemInserter(int par1) {
		super(par1, Material.iron);
		this.setCreativeTab(TechnicalWizardry.CreativeTabTWU);
		this.setUnlocalizedName(Names.SpecificItemInserter_UnlocalizedName);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    	if(Keyboard.isKeyDown(42)){
    		...
    		par3List.add("front of it in the same slot as ");
    		par3List.add(" the redstone power it is receiving");
    	} else {
    ...
    public void registerIcons(IconRegister icon)
    {
    	...
    	sideIc = icon.registerIcon(References.MOD_ID.toLowerCase() + ":" + Names.SpecificItemInserter_UnlocalizedName + "_side");
    }
	...
	public TileEntity createNewTileEntity(World world) {
		return new TESpecificItemInserter();
	}
}
