...
public class AirMomentumBlockPlusZ extends Block{

	public AirMomentumBlockPlusZ(int id) {
		super(id, Material.air);
		this.setUnlocalizedName(Names.AirMomentumBlockPlusZ_UnlocalizedName);
	}
