...
public class AirMomentumBlockPlusX extends Block{

	public AirMomentumBlockPlusX(int id) {
		super(id, Material.air);
		this.setUnlocalizedName(Names.AirMomentumBlockPlusX_UnlocalizedName);
	}
