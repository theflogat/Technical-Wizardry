package fr.theflogat.technicalWizardry.blocks.air;
...
public class AirMomentumBlockMinusZ extends Block{

	public AirMomentumBlockMinusZ(int id) {
		super(id, Material.air);
		this.setUnlocalizedName(Names.AirMomentumBlockMinusZ_UnlocalizedName);
	}
